...
import AvatarImg from "views/admin/projects/assets/avatar1.png";
                ...
                >
                    ...
                    <ModalBody>
                        ...
                        <Flex pt="1rem" pb="1rem">
                            <Flex w="50%">
                                <Avatar size='sm' />
                                <Input ml="0.5rem" variant='flushed' placeholder='Customer Name' />
                            </Flex>
                            <Flex
                                w="50%"
                                alignItems="center"
                        ...
                        <Flex pt="1rem" pb="1rem">
                            ...
                            >
                                <Avatar size='sm' />
                                <Input ml="0.5rem" variant='flushed' placeholder='Partner Name' />
                            </Flex>
                            <Flex
                                w="50%"
                                alignItems="center"
                        ...
                        >
                            <Icon as={TbTag} />
                            <Input variant='flushed' placeholder='5-7K' />
                        </Flex>
                    ...
                    <Text ml="1.5rem">Action</Text>
                    <ModalFooter
                        display="flex"
                        justifyContent="flex-start"
                        color="#FFFFFF"
                    >
                        <Button borderRadius="2rem" pl="1.5rem" pr="1.5rem" backgroundColor="#407BFF">Request Payment</Button>
                    </ModalFooter>
                </ModalContent>
            </Modal>
        </>
