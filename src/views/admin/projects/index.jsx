...
import { BsChevronBarLeft, BsChevronBarRight, BsThreeDotsVertical } from 'react-icons/bs';
                    ...
                    <TabPanels>
                        <TabPanel>
                            ...
                            <Flex justifyContent="center" alignItems="center">
                                <Icon as={BsChevronBarLeft} onClick={handlePrev} backgroundColor="#3965FF" borderRadius="2rem" color="#FFFFFF" padding="5px" width="2rem" height="2rem" />
                                <Text m="0 1rem">Page {currentPage} of {totalPages}</Text>
                                <Icon as={BsChevronBarRight} onClick={handleNext} backgroundColor="#3965FF" borderRadius="2rem" color="#FFFFFF" padding="5px" width="2rem" height="2rem" />
                            </Flex>
                        </TabPanel>
                        <TabPanel>
                            <Flex
